...
namespace Sprinkles
{
    public class Function
    {
        ...
        private UrlModelStore<SprinklesInputs> store;

        public async Task<SprinklesOutputs> Handler(SprinklesInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<SprinklesInputs>();
            }
            

            var l = new InvocationWrapper<SprinklesInputs,SprinklesOutputs> (store, Sprinkles.Execute);
